...
bfoa = ins.bacterialForagingAlgorithm(target=t, stop=s, popSize=100, gamma=0.1, probRotate=(0.01, 0.99), vel=ins.expCool(1.0, 0.99), mu=0.01)
...
bfoa.opSignals = ins.timedOp(ins.calcSignals(shape=ins.shapeClustering(0.00001, "min")), 10)
